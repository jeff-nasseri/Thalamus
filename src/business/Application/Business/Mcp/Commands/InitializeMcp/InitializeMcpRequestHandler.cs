...
/// </summary>
[IdempotentHandler]
public class InitializeMcpRequestHandler : IRequestHandler<InitializeMcpRequest, Response<IEnumerable<AgentDto>>>
{
    /// <summary>
    ...
    public Task<Response<IEnumerable<AgentDto>>> Handle(InitializeMcpRequest request,
