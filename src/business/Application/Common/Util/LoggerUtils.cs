...
public class LoggerUtils
{
    ...
    public static IDictionary<string, object> GenerateRequiredErrorLogTags(Enum @enum, BackendErrorType backendErrorType,
    ...
    {
        if (@enum is not PointOfFailure pof)
        {
            return;
        }
        ...
        string code = ErrorCodeHelper.Format(Convert.ToInt32(@enum));
