...
public class CustomSentryEventProcessor : ISentryEventProcessor
{
    ...
    {
        KeyValuePair<string, object?> pofDescription = @event.Extra.SingleOrDefault(e => e.Key == ErrorLoggerKeys.POF_EXPLANATION);
    ...
    private void SetPofCodeTag(ref SentryEvent @event)
    {
        ...
        if (pofCode.Value is not null)
        {
            @event.SetTag(ErrorLoggerKeys.POF_CODE, pofCode.Value.ToString()!);
        }
    }
    ...
    private void SetPofTag(ref SentryEvent @event)
    {
        ...
        if (pof.Value is not null)
        {
            @event.SetTag(ErrorLoggerKeys.POF, pof.Value!.ToString()!);
        }
    }
    ...
    {
        KeyValuePair<string, object?> errorDescription = @event.Extra.SingleOrDefault(e => e.Key == ErrorLoggerKeys.ERROR_EXPLANATION);
    ...
    {
        KeyValuePair<string, object?> errorCode = @event.Extra.SingleOrDefault(e => e.Key == ErrorLoggerKeys.ERROR_CODE);

        if (errorCode.Value is not null)
        {
            @event.SetTag(ErrorLoggerKeys.ERROR_CODE, errorCode.Value.ToString()!);
        }
    }
    ...
    private void SetErrorTag(ref SentryEvent @event)
    {
        ...
        {
            @event.SetTag(ErrorLoggerKeys.ERROR, error.Value.ToString()!);
        }
    }
    ...
    private void SetErrorTypeTag(ref SentryEvent @event)
    {
        ...
        {
            @event.SetTag(ErrorLoggerKeys.ERROR_TYPE, type.Value!.ToString()!);
        }
    }
    ...
    private void SetErrorGroupsTag(ref SentryEvent @event)
    {
        ...
        {
            @event.SetTag(ErrorLoggerKeys.ERROR_GROUPS, groups.Value.ToString()!);
        }
    }
    ...
    {
        KeyValuePair<string, object?> teams = @event.Extra.SingleOrDefault(e => e.Key == ErrorLoggerKeys.RESPONSIBLE_TEAMS);

        if (teams.Value is not null)
        {
            @event.SetTag(ErrorLoggerKeys.RESPONSIBLE_TEAMS, teams.Value.ToString()!);
        }
    }
}