...
public class EnvUtils
{
    ...
    /// <summary>
    /// Creates and populates an instance of type T by reading environment variables based on ConfigurationKeyNameAttribute.
    /// </summary>
    ...
    public static T GetEnvironment<T>()
    {
        ...
        foreach (PropertyInfo? property in properties)
        {
            try
            {
                string attrValue = property.GetCustomAttribute<ConfigurationKeyNameAttribute>()!.Name;
                TypeConverter converter = TypeDescriptor.GetConverter(property.PropertyType);
                string envValue = Environment.GetEnvironmentVariable(attrValue)!;
