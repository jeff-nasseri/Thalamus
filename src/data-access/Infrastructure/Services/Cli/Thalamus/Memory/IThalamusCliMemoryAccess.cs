...
public interface IThalamusCliMemoryAccess : ICliService
{
    ...
    /// </summary>
    /// <param name="args">
    ///     Command arguments including filter options: 'all', 'keywords', or 'title'. Empty or '--all' returns
    ///     all entries.
    /// </param>
    ...
    /// </summary>
    /// <param name="args">
    ///     Command arguments including 'format' (JSON, or empty for all formats) and optional 'path' (defaults
    ///     to default path if empty).
    /// </param>
